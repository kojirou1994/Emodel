...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.emodel.plist_coredata" in the application's documents Application Support directory.
...
//        let modelURL = NSBundle.mainBundle().URLForResource("plist_coredata", withExtension: "momd")!
...
//        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("plist_coredata.sqlite")
//        println(url)
